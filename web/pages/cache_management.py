...
try:
    ...
    from manufacturingagents.dataflows.optimized_us_data import get_optimized_us_data_provider
    from manufacturingagents.dataflows.optimized_china_data import get_optimized_china_data_provider
