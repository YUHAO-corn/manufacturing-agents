...
def test_google_news_tool():
    ...
    try:
        ...
        from manufacturingagents.dataflows.interface import get_google_news
...
def test_reddit_tools():
    ...
    try:
        ...
        from manufacturingagents.dataflows.interface import get_reddit_global_news, get_reddit_company_news
...
def test_toolkit_integration():
    ...
    try:
        ...
        # 检查Toolkit类是否包含这些工具
        from manufacturingagents.agents.utils.toolkit import Toolkit
