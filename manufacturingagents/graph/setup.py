...
from manufacturingagents.agents.utils.agent_states import AgentState
    ...
    def setup_graph(
        ...
        if "market" in selected_analysts:
            ...
            if (self.react_llm is not None and
                ...
                # 阿里百炼使用ReAct Agent
                from manufacturingagents.agents.analysts.market_analyst import create_market_analyst_react
        ...
        if "fundamentals" in selected_analysts:
            ...
            if (self.react_llm is not None and
                ("dashscope" in self.config.get("llm_provider", "").lower() or
                 "阿里百炼" in self.config.get("llm_provider", ""))):
                # 阿里百炼使用ReAct Agent
                from manufacturingagents.agents.analysts.fundamentals_analyst import create_fundamentals_analyst_react
